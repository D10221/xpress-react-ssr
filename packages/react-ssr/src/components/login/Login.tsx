...
export default class App extends React.Component<{}, State> {
    ...
    handleTextChanged(f: (x: string) => any): React.ChangeEventHandler<HTMLInputElement> {
        return (e) => {
            f(e.target.value)
        }
    }
        ...
        return (
            <div className="app">
                ...
                <div className="app-content">
                    <form className="app-form">
                        <div className="app-form-row">
                            ...
                            <input autoComplete="username"
                                ...
                                className="app-form-input" value={username} onChange={this.handleTextChanged(this.setUsername)} />
                        </div>
                        <div className="app-form-row">
                            ...
                            <input
                                ...
                                disabled={this.state.busy || this.state.success}
                                className="app-form-input" value={password} onChange={this.handleTextChanged(this.setPassword)} />
                        </div>
                    </form>
                    ...
                    {this.state.busy && <div className="busy">
